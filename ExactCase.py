...
evidence_data = {
   ...
   "Daniel last call was to  his cousin related to some business conflict":{"suspect":"Cousin","weight":2},
    ...
    "chef':-As you know the dining area was full and I was busy in kitchen,because today all the guest ate in restaurant itself":{"suspect": "Waiter", "weight":1}
...
def save_case_report(Detective, killer,  accomplice, innocent_people, evidences):
    with open("case_report.txt", "a") as file:
...
def intro():
    ...
    print("\n🕵️ ADAPTIVE CRIME INVESTIGATION SIMULATOR 🕵️")
    print("""
╔══════════════════════════════╗
║     CRIME INVESTIGATION      ║
║        CASE FILE #404        ║
...
""")
    ...
    Detective=input("Alloted Detective name=") 
    print("\n The alloted detective for the case #404 is",Detective) 
    next_page() 
...
def Check_Window():
    ...
    if clue not in collected_clues:
        print("\n🔍 Found: The window was broken by the bullets")
        collect_clue(clue)
    else:
...
def search_corridor():
    ...
    if clue not in collected_clues:
        print("\n🔍 Found: Someone was running in corridor in staff wear")
        collect_clue(clue)
    else:
...
def interrogate():
    ...
    if choice == "1":
        ...
        collect_clue("Watchman heard the shooting noise")
         ...
         print("\n chef':-As you know the dining area was full and I was busy in kitchen,because today all the guest ate in restaurant itself")
...
def final_accusation():
    ...
    if accused == killer and strongest_suspect == killer :
        print("\n🎉 PERFECT DEDUCTION! You solved the case brilliantly.")
        print(" Killer:", killer)
        ...
        print("\n✅ Correct killer, but evidence was weak. \n")
        print("\n Killer:", killer)
